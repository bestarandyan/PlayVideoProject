    ...
    public static void hideSupportActionBar(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (statusBar) {
            if (context instanceof FragmentActivity) {
                ...
                CommonUtil.getActivityContext(context).getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                        WindowManager.LayoutParams.FLAG_FULLSCREEN);
            }
        }
    }
    ...
    public static void showSupportActionBar(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (statusBar) {
            if (context instanceof FragmentActivity) {
                ...
                CommonUtil.getActivityContext(context).getWindow().clearFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
            }
        }
    }
